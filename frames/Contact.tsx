...
const Contact = () => {
    return (
        <div className="flex items-center flex-col pt-[4.75rem] md:pt-[5rem] lg:pt-[6rem]">
            ...
            <a href="mailto:hello@liao.gg" className="mt-4 inline-flex text-sub-light dark:text-sub-dark items-center space-x-3 border-off-white dark:border-off-black border transition-colors duration-300 py-3 px-6 rounded-lg text-sm">
