...
const Contact = () => {
    return (
        <div className="flex items-center flex-col pt-7">
            ...
            <p className="font-inter text-sub-light dark:text-sub-dark text-sm leading-snug text-center max-w-[358px]">
            ...
            <a href="mailto:hello@liao.gg" className="mt-4 inline-flex text-sub-light items-center space-x-3 border-off-white dark:border-off-black border-[1.5px] py-3 px-6 rounded-lg text-sm">
