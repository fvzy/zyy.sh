...
{ image: string | StaticImageData | { default: StaticImageData }, imageAlt: string, title: string, text: string, href: string }) => {
    return(
    <a className="flex space-x-3 md:space-x-5 cursor-pointer border-off-white dark:border-off-black transition-all duration-300 border p-3 md:py-3.5 md:px-4" href={href}>
